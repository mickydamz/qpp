        ...
        return Row(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(message.message,style: primaryTextStyle(color: white),).center().paddingOnly(left: 8, right: 8, top: 8, bottom: 8),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Image.asset(learner_ic_profile4, height: 45, width: 45, fit: BoxFit.fill).cornerRadiusWithClipRRect(25),
                        ],
                      ),
                    ),
                    SizedBox(height: 16),
